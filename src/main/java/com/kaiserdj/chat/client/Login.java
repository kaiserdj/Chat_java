...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        Variables.DetectCerrarPrograma();
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Txf_Username, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                            .addComponent(Txf_Password)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(77, 77, 77)
    ...
    private void Btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_loginActionPerformed
        Variables.usuario.inciar_sesion(Txf_Username.getText(), Txf_Password.getText());
        if (Variables.usuario.getValido()) {
            if (Variables.usuario.getTipo() == 0) {
                Main_Admin main_admin = new Main_Admin();
                main_admin.setVisible(true);
                this.setVisible(false);
            }else if(Variables.usuario.getTipo() == 1){
                JOptionPane.showMessageDialog(null, "Usuario normal inciada sesion");
            }
        }
